  ...
  //path="http://10.145.149.41/nutricion/registrar/";
    ...
    success:function(response){
      ...
      $.each(response.minutas,function(key,item){
        ...
        filas+="<tr><td><center>"+item.fecha+"</td><ter></td><td><center><a class='btn btn-primary tabla btn-xs' href='/minuta/editar_minuta/"+item.idMinutas+"'><span class='glyphicon glyphicon-search' aria-hidden='true'></span></a>    "+"    <a class='eliminar_minuta btn btn-danger tabla btn-xs' href='/minuta/eliminar_minuta/"+item.idMinutas+"')'"+"><span class='glyphicon glyphicon-trash' aria-hidden='true'></span></center></a></td></tr>";
      });
