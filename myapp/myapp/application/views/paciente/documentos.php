	...
	<div id="header" class="header navbar-default row justify-content-center justify-content-md-start">
			<!-- begin navbar-header -->
				...
				<div class="navbar-header col-xs-3 col-sm-5  col-md-4 col-lg-5 col-xl-4 ">
					<label href=""><span class="navbar-brand"><img src="<?php echo base_url();?>assets/img/logo/usuario_2.png" >  Bienvenid<?php if($this->session->userdata('sexo')=="1"){echo "o ".$this->session->userdata('nombre');}else{ echo "a ".$this->session->userdata('nombre');}?></span></label>
				</div>
	...
	<div id="page-container" class="fade">
		...
		<div class="login login-v2 " data-pageload-addclass="animated fadeIn ">
			...
			<div class="login-header row animated bounceInLeft">
				<div class="brand ">
					<img src="<?php echo base_url();?>assets/img/logo/logo.png" style="height: 70px;"> <b>NUTRICIÓN</b> Documentos Útiles
				</div>
			...
			<!-- begin login-content -->
					...
					<div class="login-buttons row animated bounceIn">
						<a href="<?php echo base_url();?>paciente/listado_evaluaciones" class="btn btn-warning btn-block btn-lg">Evaluaciones</a>
						<a href="<?php echo base_url();?>paciente/listado_minutas" class="btn btn-warning btn-block btn-lg">Minutas</a>
						<a href="<?php echo base_url();?>paciente/informe_paciente" class="btn btn-warning btn-block btn-lg">Reportes</a>
					</div>
