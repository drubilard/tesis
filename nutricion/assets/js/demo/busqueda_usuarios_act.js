  ...
  //path="http://10.145.149.41/nutricion/registrar/";
    ...
    success:function(response){
      ...
      $.each(response.usuarios,function(key,item){
        ...
        filas+="<tr><td><center>"+item.rut+"</td><td><center>"+item.Nombres+" "+item.Apellidos+"</td><td><center><a class='btn btn-danger tabla btn-xs' href='/administrador/desactivar_usuario/"+item.rut+"/')'"+"><span class='glyphicon glyphicon-remove' aria-hidden='true'></span></a></center></td></tr>";
      });
