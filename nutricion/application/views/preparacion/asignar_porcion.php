...
<body class="pace-top">
	...
	<div id="header" class="header navbar-default">
			...
			<div class="navbar-header">
				<a href="<?php echo base_url();?>administrar/administrar" class="navbar-brand"><img src="<?php echo base_url();?>assets/img/logo/logo.png"> <b>NUTRICIÓN</b> Asignar porción</a>
			</div>
		</div>
		<div id="header" class="header navbar-default">
			<nav aria-label="breadcrumb">
				  ...
				  <li class="breadcrumb-item"><a href="<?php echo base_url();?>administrar/administrar	"><strong>Administrar</strong></a></li>
					  <li class="breadcrumb-item"><a href="<?php echo base_url();?>administrar/gestion"><strong>Gestión</strong></a></li>
    				...
    				<li class="breadcrumb-item" aria-current="page">Asignar porción</li>
  				</ol>
			</nav>  			
	...
	<div class="container-fluid" class="">
		...
		<div class="login login-v2 " data-pageload-addclass="animated fadeIn ">
			...
			<div class="login-header row animated bounceInLeft">
				<div class="brand ">
					<img src="<?php echo base_url();?>assets/img/logo/logo.png" style="height: 70px;"> <b>NUTRICIÓN</b> <br> Porción para alimento <?php echo $alimento->nombre;?>
				</div>
				...
				<div class="container">
					<?php echo form_open(null,array("class"=>"margin-bottom-0"));?>
						<?php 
                            ...
                            <?php }?>
                        <label for="nombre" class="control-label">Porción <span class="text-danger">*</span></label>
						<div class="row row-space-10">
                                    <input name="porcion" class="form-control" autofocus="true" placeholder="ingresar porción"/>
						</div>
