	...
	<div id="header" class="header navbar-default">
			<nav aria-label="breadcrumb">
  				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="<?php echo base_url();?>preparacion/listado_preparaciones"><strong>Gestión preparaciones</strong></a></li>
          ...
          <?php }
			...
			<div class="row m-b-15">
				<div class="col-lg-4 col-md-6">
					<label class="control-label" for="clave" >Tipo de comida: <span class="text-danger">*</span></label>
				...
				<div class="col-lg-4 col-md-6">
					<label class="control-label" for="clave" >Tipo de nutrición: <span class="text-danger">*</span></label>
