...
<body class="pace-top">
	...
	<div id="header" class="header navbar-default">
			...
			<div class="navbar-header">
				<a href="<?php echo base_url();?>administrar/administrar" class="navbar-brand"><img src="<?php echo base_url();?>assets/img/logo/logo.png"> <b>NUTRICIÓN</b> Editar alimento</a>
			</div>
		</div>
		<div id="header" class="header navbar-default">
			<nav aria-label="breadcrumb">
				  ...
				  <li class="breadcrumb-item"><a href="<?php echo base_url();?>administrar/administrar	"><strong>Administrar</strong></a></li>
					  ...
					  <li class="breadcrumb-item"><a href="<?php echo base_url();?>alimento/listado_alimentos"><strong>Gestión de alimentos</strong></a></li>
