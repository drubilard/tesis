...
<head>
	...
	<!-- ================== BEGIN BASE JS ================== -->
  <script src="http://mard.cl/nutricion/assets/js/demo/jquery.min.js"></script>
	...
	<!-- begin #page-container -->
		...
		<div id="header" class="header navbar-default">
			...
			<div class="navbar-header">
				<a href="http://mard.cl/nutricion/administrar/administrar" class="navbar-brand"><img src="http://mard.cl/nutricion/assets/img/logo/logo.png"> <b>NUTRICIÓN</b> evaluación</a>
			</div>
			<div class="right-content">
				<nav aria-label="breadcrumb" >
  					<ol class="breadcrumb">
    					<li class="breadcrumb-item"><a href="http://mard.cl/nutricion/administrar/administrar"><strong> Administración</strong></a></li>
