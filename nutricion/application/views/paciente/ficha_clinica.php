    ...
    <div id="header" class="header navbar-default row justify-content-center justify-content-md-start">
			<!-- begin navbar-header -->
				<div class="navbar-header col-xs-8 col-md-8 col-lg-10">
					<a href="<?php echo base_url();?>administrar/administrar" class="navbar-brand"><img src="<?php echo base_url();?>assets/img/logo/logo.png"  > <b>NUTRICIÓN</b> ficha clínica</a>
				</div>
    ...
    <div id="header" class="header navbar-default">
			<nav aria-label="breadcrumb">
  				<ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page">Ficha clínica</li>
  				</ol>
			</nav>  			
		...
		<div class="login login-v2 " data-pageload-addclass="animated fadeIn ">
			...
			<!-- begin login-content -->
					...
					<div class="login-buttons row animated bounceIn">
						<a href="<?php echo base_url();?>paciente/nueva_ficha/<?php echo $rut_paciente?>" class="btn btn-success btn-block btn-lg">Nueva ficha</a>
						<a href="<?php echo base_url();?>paciente/listado_fichas/<?php echo $rut_paciente?>" class="btn btn-warning btn-block btn-lg">Consultar ficha</a>
					</div>
