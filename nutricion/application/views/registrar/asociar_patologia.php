...
<body class="pace-top">
  ...
  <div id="header" class="header navbar-default row justify-content-center justify-content-md-start">
    ...
    <div id="header" class="header navbar-default">
      <nav aria-label="breadcrumb">
          ...
          <li class="breadcrumb-item" aria-current="page">Asociar patologías</li>
          </ol>
      </nav>        
  ...
  <div id="page-container" class="fade">
    ...
    <div class="panel panel-success">
        ...
        <div class="panel-heading">Listado de patologías</div>
    ...
    <div class="container-fluid">
        <div class="row">
          ...
          <form method="post">
        <button type="submit" class="btn btn-md btn-warning"><span class="glyphicon glyphicon-plus"></span> Asignar patologías a <?php echo $datos_paciente->nombre;?></button> 
          </div>
        ...
        <div class="table-responsive">
            ...
            <th><center>Agregar</center></th>
                ...
                <tbody id="body_patologias">
          <?php foreach($patologias as $pat){?>
            <tr>
              <td>
                <center><?php echo $pat->nombre?></center>
              </td>
              <td>
                <center><?php echo $pat->Grupo_patologico?></center>
              </td>
              <td>
                <center><input type="checkbox"  <?php foreach($patologias_asociadas as $value){if($pat->idPatologia==$value->Patologia_idPatologia){?>checked <?php }}  ?>value="<?php echo $pat->idPatologia;?>" name="patologias_asociadas[]"></center>
              </td>
            </tr>
          <?php } ?>
          </form>
