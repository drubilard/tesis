		...
		<div id="header" class="header navbar-default">
			...
			<nav aria-label="breadcrumb">
  				<ol class="breadcrumb">
    				...
    				<li class="breadcrumb-item" aria-current="page">Listado de preparaciones</li>
  				</ol>
			</nav>
		</div>
                ...
                <tbody>
                    <?php
                        ...
                        foreach($preparaciones as $preparacion)
                        {
                            ...
                            <tr>
                                <td><?php echo $i?></td>
                                <td><?php echo $preparacion->nombre;?></td>
                                <td><?php echo $preparacion->tipo;?></td>
                                <td>
                                    <a href="<?php echo base_url()?>registrar/editar_preparacion/<?php echo $preparacion->id?>/<?php echo $pagina?>"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></a>
                                    <a href="javascript:void(0);" onclick="eliminar('<?php echo base_url()?>registrar/eliminar_preparacion/<?php echo $preparacion->id?>/<?php echo $pagina?>')"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
                                </td>
                            </tr>
                            <?php
                           	$i++;
