...
<body class="pace-top">
    ...
    <div class="panel panel-success">
        ...
        <div class="panel-body">
            ...
            <p>
                <a href="<?php echo base_url()?>registrar/add_pat_hab" class="btn btn-warning"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Agregar</a>
            </p>
                    ...
                    <?php
                        ...
                        foreach($datos as $dato)
                        {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url()?>registrar/editar_pat_hab/<?php echo $dato->id?>/<?php echo $pagina?>"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></a>
                                    <a href="javascript:void(0);" onclick="eliminar('<?php echo base_url()?>registrar/eliminar_pat_hab/<?php echo $dato->id?>/<?php echo $pagina?>')"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
                                </td>
                            </tr>
                            <?php
                           	$i++;
