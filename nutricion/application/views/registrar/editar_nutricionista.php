...
<body class="pace-top">
	...
	<div id="header" class="header navbar-default">
			...
			<div class="navbar-header">
				<a href="<?php echo base_url();?>registrar/administrar" class="navbar-brand"><img src="<?php echo base_url();?>assets/img/logo/logo.png"> <b>NUTRICIÓN</b> Editar nutricionista</a>
			</div>
		</div>
		<div id="header" class="header navbar-default">
