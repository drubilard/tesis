...
<body class="pace-top">
	...
	<!-- begin #page-container -->
		...
		<div id="header" class="header navbar-default">
			<nav aria-label="breadcrumb">
  				<ol class="breadcrumb">
    				<li class="breadcrumb-item"><a href="<?php echo base_url();?>registrar/listado_pat_hab"><strong>Listado patología y hábitos</strong></a></li>
    				<li class="breadcrumb-item" aria-current="page">Editar patología o Hábito</li>
  				</ol>
			</nav>  			
    ...
    <div class="panel panel-success">
        <div class="panel-heading">Agregar Patología o Hábito</div>
        <div class="panel-body">
          ...
          <?php }
            ...
            <p>
                ...
                <input type="text" name="nombre_pat_hab" value="<?php echo set_value_input(array(),'nombre','nombre')?>" class="form-control" autofocus="true" />
            </p>
