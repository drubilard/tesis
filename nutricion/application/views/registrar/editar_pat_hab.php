	...
	<!-- begin #page-container -->
		...
		<div id="header" class="header navbar-default">
			<nav aria-label="breadcrumb">
  				<ol class="breadcrumb">
    				<li class="breadcrumb-item"><a href="<?php echo base_url();?>registrar/listado_pat_hab"><strong>Listado patología/hábito</strong></a></li>
    				<li class="breadcrumb-item" aria-current="page">Editar patología/hábito</li>
  				</ol>
			</nav>  			
        ...
        <div class="panel-body">
          ...
          <?php }
            ...
            <p>
                ...
                <input type="text" name="nombre_pat_hab" value="<?php echo $datos->nombre;?>" class="form-control" autofocus="true" />
            </p>
			...
			<div class="col-md-12">
				...
				<label class="container">Patología
  					<input type="radio" value="1" name="tipo" <?php if($datos->tipo==1){?> checked=""<?php }?>>
 						<span class="checkmark"></span>
					</label>
					<label class="container">Hàbito
  						<input type="radio" value="2" name="tipo"<?php if($datos->tipo==2){?> checked=""<?php }?> >
  							<span class="checkmark"></span>
					</label>
			</div>
			</div>
