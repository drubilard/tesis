...
<body class="pace-top">
	...
	<div id="header" class="header navbar-default">
			...
			<div class="navbar-header">
				<a href="<?php echo base_url();?>registrar/administrar" class="navbar-brand"><img src="<?php echo base_url();?>assets/img/logo/logo.png"> <b>NUTRICIÓN</b> Ingreso de alimento</a>
			</div>
		</div>
		<div id="header" class="header navbar-default">
			<nav aria-label="breadcrumb">
  				<ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo base_url();?>registrar/listado_fichas/<?php echo $datos->rut?>"><strong>Listado fichas</strong></a></li>
