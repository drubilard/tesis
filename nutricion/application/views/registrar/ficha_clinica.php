		...
		<div class="login login-v2 " data-pageload-addclass="animated fadeIn ">
			...
			<!-- begin login-content -->
					...
					<div class="login-buttons row animated bounceIn">
						<a href="<?php echo base_url();?>registrar/nueva_ficha/<?php echo $rut_paciente?>" class="btn btn-success btn-block btn-lg">Nueva ficha</a>
						<a href="<?php echo base_url();?>registrar/listado_fichas/<?php echo $rut_paciente?>" class="btn btn-warning btn-block btn-lg">Consultar ficha</a>
					</div>
