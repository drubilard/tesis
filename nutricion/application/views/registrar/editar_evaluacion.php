		...
		<div id="header" class="header navbar-default">
			...
			<nav aria-label="breadcrumb">
  				<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="<?php echo base_url();?>registrar/listado_evaluaciones/<?php echo $datos_paciente->rut?>"><strong>Consultar evaluaciones</strong></a></li>
        		...
        		<div class="col-md-6">
        			<div class="form-group row">
    					<label for="peso" class="col-sm-2 col-form-label"><strong>IMC:</strong></label>
    						<div class="col-md-3">
    							<div class="input-group">
      								<input type="text" name="imc" class="form-control" readonly value="0" id="imc_id" placeholder="" value="<?php echo $datos_evaluacion->imc_paciente?>">
          		...
          		<div class="col-md-6">
              		<div class="form-group row">
    					<label for="peso" class="col-sm-2 col-form-label">Húmero:</label>
    						<div class="col-md-3">
    							<div class="input-group">
      								<input type="text" name="humero" class="form-control" id="humero_id" placeholder="" value="<?php echo $datos_evaluacion->humero_paciente?>">
      									<span class="input-group-addon">Mts.</span>
      							</div>
    						</div>
  					</div>
    			...
    			<div class="col-md-6">
  					<div class="form-group row">
    					<label for="talla" class="col-sm-2 col-form-label">Fémur:</label>
    						<div class="col-md-3">
    							<div class="input-group">
      								<input type="text" name="femur" class="form-control" id="femur_id" placeholder="" value="<?php echo $datos_evaluacion->femur_paciente?>">
      									<span class="input-group-addon">Mts.</span>
    							</div>
    						</div>
  					</div>
