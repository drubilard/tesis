			...
			<div class="card">
				<div class="card-header" id="headingOne">
					<center><h5 class="mb-0">
						<button type="button" class="btn btn-warning <?php if (detectar_SO()){  echo 'btn-minuta-xs';} else { echo 'btn-minuta-lg';}?>" data-toggle="collapse" data-target="#bebestible" aria-expanded="true" aria-controls="bebestible">
							Bebestible
						</button>
					</h5></center>
				</div>
				<div id="bebestible" class="collapse" aria-labelledby="headingOne1" data-parent="#accordion">
					<div class="card-body">
						<!-- ingresar-->
						<?php foreach($preparaciones as $preparacion){?>
								<?php if ($preparacion->tipo=='bebestible'){?><input type="checkbox" name="preparaciones_minuta_beb[]" value="<?php echo $preparacion->idpreparacion;?>"> <span class="color-preparacion"> <?php echo $preparacion->nombre;?></span>
								<hr><?php }?>
						<?php } ?>
					</div>
				</div>
			...
			<div class="card">
				...
				<div id="desayuno" class="collapse" aria-labelledby="headingOne1" data-parent="#accordion">
					<div class="card-body">
						<!-- ingresar-->
						<?php foreach($preparaciones as $preparacion){?>
								<?php if ($preparacion->tipo=='desayuno'){?><input type="checkbox" name="preparaciones_minuta_des[]" value="<?php echo $preparacion->idpreparacion;?>"> <span class="color-preparacion"> <?php echo $preparacion->nombre;?></span>
								<hr><?php }?>
						<?php } ?>
					</div>
				</div>
			...
			<div class="card">
				...
				<div id="colacion_1" class="collapse" aria-labelledby="headingOne1" data-parent="#accordion">
					<div class="card-body">
						<!-- ingresar-->
						<?php foreach($preparaciones as $preparacion){?>
								<?php if ($preparacion->tipo=='colacion_1'){?><input type="checkbox" name="preparaciones_minuta_col[]" value="<?php echo $preparacion->idpreparacion;?>"> <span class="color-preparacion"> <?php echo $preparacion->nombre;?></span>
								<hr><?php }?>
						<?php } ?>
					</div>
				</div>
			...
			<div class="card">
				...
				<div id="entrada" class="collapse" aria-labelledby="headingOne1" data-parent="#accordion">
					<div class="card-body">
						<!-- ingresar-->
						<?php foreach($preparaciones as $preparacion){?>
								<?php if ($preparacion->tipo=='entrada'){?><input type="checkbox" name="preparaciones_minuta_ent[]" value="<?php echo $preparacion->idpreparacion;?>"> <span class="color-preparacion"> <?php echo $preparacion->nombre;?></span>
								<hr><?php }?>
						<?php } ?>
					</div>
				</div>
			...
			<div class="card">
				...
				<div id="almuerzo" class="collapse" aria-labelledby="headingOne1" data-parent="#accordion">
					<div class="card-body">
						<!-- ingresar-->
						<?php foreach($preparaciones as $preparacion){?>
								<?php if ($preparacion->tipo=='almuerzo'){?><input type="checkbox" name="preparaciones_minuta_alm[]" value="<?php echo $preparacion->idpreparacion;?>"> <span class="color-preparacion">  <?php echo $preparacion->nombre;?></span>
								<hr><?php }?>
						<?php } ?>
					</div>
				</div>
			...
			<div class="card">
				...
				<div id="colacion_2" class="collapse" aria-labelledby="headingOne1" data-parent="#accordion">
					<div class="card-body">
						<!-- ingresar-->
						<?php foreach($preparaciones as $preparacion){?>
								<?php if ($preparacion->tipo=='colacion_2'){?><input type="checkbox" name="preparaciones_minuta_col_2[]" value="<?php echo $preparacion->idpreparacion;?>"> <span class="color-preparacion"> <?php echo $preparacion->nombre;?></span>
								<hr><?php }?>
						<?php } ?>
					</div>
				</div>
			...
			<div class="card">
				...
				<div id="once" class="collapse" aria-labelledby="headingOne1" data-parent="#accordion">
					<div class="card-body">
						<!-- ingresar-->
						<?php foreach($preparaciones as $preparacion){?>
								<?php if ($preparacion->tipo=='once'){?><input type="checkbox" name="preparaciones_minuta_on[]" value="<?php echo $preparacion->idpreparacion;?>"> <span class="color-preparacion"> <?php echo $preparacion->nombre;?></span>
								<hr><?php }?>
						<?php } ?>
					</div>
				</div>
			...
			<div class="card">
				...
				<div id="cena" class="collapse" aria-labelledby="headingOne1" data-parent="#accordion">
					<div class="card-body">
						<!-- ingresar-->
						<?php foreach($preparaciones as $preparacion){?>
								<?php if ($preparacion->tipo=='cena'){?><input type="checkbox" name="preparaciones_minuta_cen[]" value="<?php echo $preparacion->idpreparacion;?>"> <span class="color-preparacion"> <?php echo $preparacion->nombre;?></span>
								<hr><?php }?>
						<?php } ?>
					</div>
				</div>
