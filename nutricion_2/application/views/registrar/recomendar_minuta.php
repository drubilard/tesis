<?php $comidas =['bebestible','desayuno','colacion_1','entrada','almuerzo','colacion_2','once','cena'];?>
...
<body class="pace-top">
  ...
  <div id="header" class="header navbar-default">
			<nav aria-label="breadcrumb">
  				<ol class="breadcrumb">
    				...
    				<li class="breadcrumb-item"><a href="<?php echo base_url();?>registrar/gestion_minuta/<?php echo $id?>"><strong>Gestión minuta</strong></a></li>
                    <li class="breadcrumb-item" aria-current="page">Recomendación de minuta</li>
  ...
  <div id="page-container" class="fade">
    ...
    <div class= " <?php if(detectar_SO()){ echo 'login login-v2';}else{ echo 'container-fluid';}?> " data-pageload-addclass="animated fadeIn ">
      ...
      <!-- begin login-content -->
      <form method="post">
        <button type="submit"  class="btn btn-danger"><span class="glyphicon glyphicon-plus"></span> Crear minuta</button>
        <br>
        <br>
<div class="row">  
        ...
        <div id="desayuno" class="collapse" aria-labelledby="headingOne1" data-parent="#accordion">
          <div class="card-body">
            ...
            <?php foreach($preparaciones as $preparacion){?>
                <?php if ($preparacion->tipo=='desayuno'){?><input type="checkbox" <?php foreach($preparaciones_permitidas as $value){if($preparacion->idpreparacion==$value->id){?>checked <?php }}  ?>  name="preparaciones_minuta_des[]" value="<?php echo $preparacion->idpreparacion;?>"> <span class="color-preparacion"> <?php echo $preparacion->nombre;?></span>
                <hr><?php }?>
            <?php } ?>
          </div>
        </div>
      ...
      <div class="card">
        ...
        <div id="colacion_1" class="collapse" aria-labelledby="headingOne1" data-parent="#accordion">
          <div class="card-body">
            <!-- ingresar-->
            <?php foreach($preparaciones as $preparacion){?>
                <?php if ($preparacion->tipo=='colacion_1'){?><input type="checkbox" <?php foreach($preparaciones_permitidas as $value){if($preparacion->idpreparacion==$value->id){?>checked <?php }}  ?>  name="preparaciones_minuta_col[]" value="<?php echo $preparacion->idpreparacion;?>"> <span class="color-preparacion"> <?php echo $preparacion->nombre;?></span>
                <hr><?php }?>
            <?php } ?>
          </div>
        </div>
      ...
      <div class="card">
        ...
        <div id="entrada" class="collapse" aria-labelledby="headingOne1" data-parent="#accordion">
          <div class="card-body">
            <!-- ingresar-->
            <?php foreach($preparaciones as $preparacion){?>
                <?php if ($preparacion->tipo=='entrada'){?><input type="checkbox"  <?php foreach($preparaciones_permitidas as $value){if($preparacion->idpreparacion==$value->id){?>checked <?php }}  ?> name="preparaciones_minuta_ent[]" value="<?php echo $preparacion->idpreparacion;?>"> <span class="color-preparacion"> <?php echo $preparacion->nombre;?></span>
                <hr><?php }?>
            <?php } ?>
          </div>
        </div>
      ...
      <div class="card">
        ...
        <div id="almuerzo" class="collapse" aria-labelledby="headingOne1" data-parent="#accordion">
          <div class="card-body">
            <!-- ingresar-->
            <?php foreach($preparaciones as $preparacion){?>
                <?php if ($preparacion->tipo=='almuerzo'){?><input type="checkbox" <?php foreach($preparaciones_permitidas as $value){if($preparacion->idpreparacion==$value->id){?>checked <?php }}  ?>  name="preparaciones_minuta_alm[]" value="<?php echo $preparacion->idpreparacion;?>"> <span class="color-preparacion">  <?php echo $preparacion->nombre;?></span>
                <hr><?php }?>
            <?php } ?>
          </div>
        </div>
      ...
      <div class="card">
        ...
        <div id="colacion_2" class="collapse" aria-labelledby="headingOne1" data-parent="#accordion">
          <div class="card-body">
            <!-- ingresar-->
            <?php foreach($preparaciones as $preparacion){?>
                <?php if ($preparacion->tipo=='colacion_2'){?><input type="checkbox" <?php foreach($preparaciones_permitidas as $value){if($preparacion->idpreparacion==$value->id){?>checked <?php }}  ?>  name="preparaciones_minuta_col_2[]" value="<?php echo $preparacion->idpreparacion;?>"> <span class="color-preparacion"> <?php echo $preparacion->nombre;?></span>
                <hr><?php }?>
            <?php } ?>
          </div>
        </div>
      ...
      <div class="card">
        ...
        <div id="once" class="collapse" aria-labelledby="headingOne1" data-parent="#accordion">
          <div class="card-body">
            <!-- ingresar-->
            <?php foreach($preparaciones as $preparacion){?>
                <?php if ($preparacion->tipo=='once'){?><input type="checkbox" <?php foreach($preparaciones_permitidas as $value){if($preparacion->idpreparacion==$value->id){?>checked <?php }}  ?>  name="preparaciones_minuta_on[]" value="<?php echo $preparacion->idpreparacion;?>"> <span class="color-preparacion"> <?php echo $preparacion->nombre;?></span>
                <hr><?php }?>
            <?php } ?>
          </div>
        </div>
      ...
      <div class="card">
        ...
        <div id="cena" class="collapse" aria-labelledby="headingOne1" data-parent="#accordion">
          <div class="card-body">
            <!-- ingresar-->
            <?php foreach($preparaciones as $preparacion){?>
                <?php if ($preparacion->tipo=='cena'){?><input type="checkbox" <?php foreach($preparaciones_permitidas as $value){if($preparacion->idpreparacion==$value->id){?>checked <?php }}  ?>  name="preparaciones_minuta_cen[]" value="<?php echo $preparacion->idpreparacion;?>"> <span class="color-preparacion"> <?php echo $preparacion->nombre;?></span>
                <hr><?php }?>
            <?php } ?>
          </div>
        </div>
