		...
		<div class="login login-v2 " data-pageload-addclass="animated fadeIn ">
			...
			<!-- begin login-content -->
					...
					<div class="login-buttons row animated bounceIn">
						<a href="<?php echo base_url();?>registrar/planilla_evaluacion/<?php echo $rut_paciente?>" class="btn btn-success btn-block btn-lg">Nueva Evaluación</a>
						<a href="<?php echo base_url();?>registrar/listado_evaluaciones/<?php echo $rut_paciente?>" class="btn btn-warning btn-block btn-lg">Consultar evaluaciones</a>
					</div>
