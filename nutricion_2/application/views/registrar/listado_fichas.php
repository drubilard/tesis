...
<body class="pace-top">
		...
		<div id="header" class="header navbar-default">
			<nav aria-label="breadcrumb">
  				<ol class="breadcrumb">
    				...
    				<li class="breadcrumb-item"><a href="<?php echo base_url();?>registrar/ficha_clinica/<?php echo $datos_paciente->rut?>"><strong>Ficha clinica</strong></a></li>
            ...
            <div class="panel-body">
				<div class="table-responsive">
  					<table class="table table-hover table-bordered">
						<thead>
							<tr>
                                <th><center>Fechas de ficha clínica</center></th>
                                <th><center>Opciones</center></th>
							</tr>
						</thead>
						<tbody id="body_fichas">
						</tbody>
    ...
    <script src="<?php echo base_url();?>assets/js/demo/buscar_fichas.js"></script>
