		...
		<div id="header" class="header navbar-default row justify-content-center justify-content-md-start">
			<!-- begin navbar-header -->
				<div class="navbar-header col-xs-8 col-md-8 col-lg-10">
					<a href="<?php echo base_url();?>registrar/administrar" class="navbar-brand"><img src="<?php echo base_url();?>assets/img/logo/logo.png"  > <b>NUTRICIÓN</b> Minuta</a>
				</div>
		...
		<div id="header" class="header navbar-default">
			<nav aria-label="breadcrumb">
  				<ol class="breadcrumb">
    				...
    				<li class="breadcrumb-item" aria-current="page">Gestión minutas</li>
  				</ol>
			</nav>  			
	...
	<div id="page-container" class="fade">
		...
		<div class="login login-v2" data-pageload-addclass="animated fadeIn">
			...
			<div class="login-header animated bounceInLeft">
				<div class="brand">
					<img src="<?php echo base_url();?>assets/img/logo/logo.png" style="height: 70px;"> <b>NUTRICIÓN</b> Evaluación Minutas
				</div>
			</div>
			<br>
			...
			<!-- begin login-content -->
					...
					<div class="login-buttons animated bounceIn ">
						<a href="<?php echo base_url();?>registrar/crear_minuta/<?php echo $id;?>" class="btn btn-warning btn-block btn-lg">Crear minuta</a>
						<a href="<?php echo base_url();?>registrar/recomendar_minuta/<?php echo $id;?>" class="btn btn-warning btn-block btn-lg">Recomendación minuta</a>
						<a href="<?php echo base_url();?>registrar/listado_minutas/<?php echo $id;?>" class="btn btn-warning btn-block btn-lg">Consultar minuta</a>
					</div>
