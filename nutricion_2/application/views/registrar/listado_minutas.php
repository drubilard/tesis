...
<body class="pace-top">
		...
		<div id="header" class="header navbar-default">
			<nav aria-label="breadcrumb">
  				<ol class="breadcrumb">
    				...
    				<li class="breadcrumb-item"><a href="<?php echo base_url();?>registrar/gestion_minuta/<?php echo $datos->rut;?>"><strong>Gestión minutas</strong></a></li>
    ...
    <div class="panel panel-success">
        ...
        <div class="panel-heading">Listado de minutas </div>
            ...
            <div class="panel-body">
				<div class="table-responsive">
  					<table class="table table-hover table-bordered">
						<thead>
							<tr>
                                <th><center>Fechas de minuta</center></th>
                                <th><center>Opciones</center></th>
							</tr>
						</thead>
						<tbody id="body_minutas">
						</tbody>
    ...
    <script src="<?php echo base_url();?>assets/js/demo/buscar_minutas.js"></script>
