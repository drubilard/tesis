...
//path="http://localhost:8000/minuta/";
    ...
    success:function(response){
      breadcrumb= "<nav aria-label='breadcrumb'><ol class='breadcrumb'><li class='breadcrumb-item'><a href='"+path+"paciente/documentos'><strong>Documentos</strong></a></li><li class='breadcrumb-item' aria-current='page'>Consulta de minutas</li></ol></nav> ";
      filas = "";
      $.each(response.minutas,function(key,item){
        //console.log(response.paciente);
        filas+="<tr><td><center>"+item.fecha+"</center></td><td><center><a class='btn btn-danger tabla btn-xs' href='"+path+"minuta/pdf/"+rut+"/"+item.idMinutas+"'"+"><span class='glyphicon glyphicon-download' aria-hidden='true'></span></a></center></td></tr>";
      });
