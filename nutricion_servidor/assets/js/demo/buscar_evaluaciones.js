...
//path="http://10.145.149.41/nutricion/registrar/";
  ...
  success:function(response){
    ...
    $.each(response.evaluaciones,function(key,item){
      ...
      filas+="<tr><td><center>"+item.fecha+"</td><center><td><center>"+item.estado+"</td><center></td><td><center><a class='btn btn-primary tabla btn-xs' href='/nutricion/registrar/editar_evaluacion/"+item.idevaluacion_nutricional+"'"+"><span class='glyphicon glyphicon-search' aria-hidden='true'></span></a>    "+"    <a class='eliminar_evaluacion btn btn-danger tabla btn-xs' href='/nutricion/registrar/eliminar_evaluacion/"+item.idevaluacion_nutricional+"')'"+"><span class='glyphicon glyphicon-trash' aria-hidden='true'></span></center></a></td></tr>";
