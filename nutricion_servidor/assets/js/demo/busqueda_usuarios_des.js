...
//path="http://localhost:8000/administrador/";
    ...
    success:function(response){
      ...
      $.each(response.usuarios,function(key,item){
        ...
        filas+="<tr><td><center>"+item.rut+"</td><td><center>"+item.Nombres+" "+item.Apellidos+"</td><td><center><a class='btn btn-primary tabla btn-xs' href='"+path+"activar_usuario/"+item.rut+"/')'"+"><span class='glyphicon glyphicon-ok' aria-hidden='true'></span></a></center></td></tr>";
      });
