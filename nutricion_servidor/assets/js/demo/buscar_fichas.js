...
function mostrarDatos(rut_paciente,valorBuscar,pagina,cantidad){
  path="http://mard.cl/nutricion/paciente/";
//path="http://localhost:8000/paciente/";
    ...
    success:function(response){
      ...
      $.each(response.fichas,function(key,item){
        ...
        filas+="<tr><td><center>"+item.fecha+"</td><ter></td><td><center><a class='btn btn-primary tabla btn-xs' href='"+path+"editar_ficha/"+item.id+"'"+"><span class='glyphicon glyphicon-search' aria-hidden='true'></span></a>    "+"    <a class='eliminar_ficha btn btn-danger tabla btn-xs' href='"+path+"eliminar_ficha/"+item.id+"')'"+"><span class='glyphicon glyphicon-trash' aria-hidden='true'></span></center></a></td></tr>";
      });
