...
$(document).ready(function(){
  ...
  $("body").on("click",".paginacion li a",function(e){
    ...
    $("#body_fichas").on("click",".eliminar_ficha",function(e){
        e.preventDefault();
  ...
  //path="http://10.145.149.41/nutricion/registrar/"
    ...
    success:function(response){
      ...
      $.each(response.fichas,function(key,item){
        ...
        filas+="<tr><td><center>"+item.fecha+"</td><ter></td><td><center><a class='btn btn-primary tabla btn-xs' href='/nutricion_servidor/paciente/editar_ficha/"+item.id+"'"+"><span class='glyphicon glyphicon-search' aria-hidden='true'></span></a>    "+"    <a class='eliminar_ficha btn btn-danger tabla btn-xs' href='/nutricion_servidor/paciente/eliminar_ficha/"+item.id+"')'"+"><span class='glyphicon glyphicon-trash' aria-hidden='true'></span></center></a></td></tr>";
      });
