...
//path="http://localhost:8000/alimento/";
    ...
    success:function(response){
      ...
      $.each(response.alimento,function(key,item){
        filas+="<tr><td><center>"+item.idAlimento+"<center></td><td><center>"+item.nombre+"<center></td><td><center>"+item.tipo+"<center></td><td><center><a href='"+path+"restringir_alimentos/"+rut+"/"+item.idAlimento+"' class=' btn btn-danger glyphicon glyphicon-ban-circle'></center></td></tr>";
      });
