		...
		<div class="login login-v2" data-pageload-addclass="animated fadeIn">
			...
			<!-- begin login-content -->
					...
					<div class="login-buttons animated bounceIn ">
						<a href="<?php echo base_url();?>alimento/listado_alimentos" class="btn btn-warning btn-block btn-lg">Gestión de alimentos</a>
						<a href="<?php echo base_url();?>patologia/listado_patologias" class="btn btn-warning btn-block btn-lg">Gestión de patologías</a>
						<a href="<?php echo base_url();?>preparacion/listado_preparaciones" class="btn btn-warning btn-block btn-lg">Gestión de preparaciones</a>
					</div>
