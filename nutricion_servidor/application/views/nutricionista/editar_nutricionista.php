...
<body class="pace-top">
	...
	<div id="header" class="header navbar-default">
			...
			<div class="navbar-header">
				<a href="<?php echo base_url();?>administrar/administrar" class="navbar-brand"><img src="<?php echo base_url();?>assets/img/logo/logo.png"> <b>NUTRICIÓN</b> Editar nutricionista</a>
			</div>
		</div>
		<div id="header" class="header navbar-default">
			<nav aria-label="breadcrumb">
  				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item" aria-current="page">Editar nutricionista</li>
  				</ol>
			</nav>  			
	...
	<div class="container-fluid" class="">
		...
		<div class="login login-v2 " data-pageload-addclass="animated fadeIn ">
			...
			<div class="login-header row animated bounceInLeft">
				<div class="brand ">
					<img src="<?php echo base_url();?>assets/img/logo/logo.png" style="height: 70px;"> <b>NUTRICIÓN</b> Editar nutricionista
				</div>
