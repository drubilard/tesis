          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <label for="peso" class="col-sm-2 col-form-label"><strong>Fecha Evaluación:</strong></label>
                <div class="col-md-4">
                    <label for="fecha_control" class="col-sm-12 col-form-label"><?php echo $datos_evaluacion->fecha;?></label>
              ...
              <label for="peso" class="col-sm-2 col-form-label">Peso:</label>
                <div class="col-md-3">
                  <div class="input-group">
                        <span class="input-group-addon"><?php echo $datos_evaluacion->peso_paciente." "?>Kgs.</span>
                    </div>
                </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group row">
              <label for="talla" class="col-sm-2 col-form-label">Talla:</label>
                <div class="col-md-3">
                  <div class="input-group">
                      <span class="input-group-addon"><?php echo $datos_evaluacion->talla_paciente." "?>Mts.</span>
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <label for="peso" class="col-sm-2 col-form-label"><strong>IMC:</strong></label>
                <div class="col-md-3">
                  <div class="input-group">
                        <span class="input-group-addon"><?php echo $datos_evaluacion->imc_paciente?></span>
                    </div>
                </div>
            </div>
            </div>
        ...
        <div class="container">
          <div class="row">
              ...
              <label for="peso" class="col-sm-2 col-form-label">Brazo relajado:</label>
                <div class="col-md-3">
                  <div class="input-group">
                        <span class="input-group-addon"><?php echo $datos_evaluacion->brazo_relajado_paciente." "?>Cms.</span>
                    </div>
                </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group row">
              <label for="talla" class="col-sm-2 col-form-label">Brazo contraido:</label>
                <div class="col-md-3">
                  <div class="input-group">
                        <span class="input-group-addon"><?php echo $datos_evaluacion->brazo_contraido_paciente." "?>Cms.</span>
                  </div>
                </div>
            </div>
          </div>
          ...
          <div class="row">
              ...
              <label for="peso" class="col-sm-2 col-form-label">Cintura min:</label>
                <div class="col-md-3">
                  <div class="input-group">
                        <span class="input-group-addon"><?php echo $datos_evaluacion->cintura_min_paciente." "?>Cms.</span>
                    </div>
                </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group row">
              <label for="talla" class="col-sm-2 col-form-label">Cadera máx:</label>
                <div class="col-md-3">
                  <div class="input-group">
                        <span class="input-group-addon"><?php echo $datos_evaluacion->cadera_max_paciente." "?>Cms.</span>
                  </div>
                </div>
            </div>
          </div>
          ...
          <div class="row">
              ...
              <label for="peso" class="col-sm-2 col-form-label">Muslo medio:</label>
                <div class="col-md-3">
                  <div class="input-group">
                        <span class="input-group-addon"><?php echo $datos_evaluacion->muslo_medio_paciente." "?>Cms.</span>
                    </div>
                </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group row">
              <label for="talla" class="col-sm-2 col-form-label">Pantorrilla:</label>
                <div class="col-md-3">
                  <div class="input-group">
                        <span class="input-group-addon"><?php echo $datos_evaluacion->pantorrilla_paciente." "?>Cms.</span>
                  </div>
                </div>
            </div>
          </div>
        ...
        <div class="container">
          <div class="row">
              ...
              <label for="peso" class="col-sm-2 col-form-label">Tricipital:</label>
                <div class="col-md-3">
                  <div class="input-group">
                        <span class="input-group-addon"><?php echo $datos_evaluacion->tricipital_paciente." "?>Cms.</span>
                    </div>
                </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group row">
              <label for="talla" class="col-sm-2 col-form-label">Subescapular:</label>
                <div class="col-md-3">
                  <div class="input-group">
                        <span class="input-group-addon"><?php echo $datos_evaluacion->subescapular_paciente." "?>Cms.</span>
                  </div>
                </div>
            </div>
          </div>
          ...
          <div class="row">
              ...
              <label for="peso" class="col-sm-2 col-form-label">Bicipital:</label>
                <div class="col-md-3">
                  <div class="input-group">
                        <span class="input-group-addon"><?php echo $datos_evaluacion->bicipital_paciente." "?>Cms.</span>
                    </div>
                </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group row">
              <label for="talla" class="col-sm-2 col-form-label">Supracrestídeo:</label>
                <div class="col-md-3">
                  <div class="input-group">
                        <span class="input-group-addon"><?php echo $datos_evaluacion->supracrestideo_paciente." "?>Cms.</span>
                  </div>
                </div>
            </div>
          </div>
          ...
          <div class="row">
              ...
              <label for="peso" class="col-sm-2 col-form-label">Supraespinal:</label>
                <div class="col-md-3">
                  <div class="input-group">
                        <span class="input-group-addon"><?php echo $datos_evaluacion->supraespinal_paciente." "?>Cms.</span>
                    </div>
                </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group row">
              <label for="talla" class="col-sm-2 col-form-label">Abdominal:</label>
                <div class="col-md-3">
                  <div class="input-group">
                        <span class="input-group-addon"><?php echo $datos_evaluacion->abdominal_paciente." "?>Cms.</span>
                  </div>
                </div>
            </div>
          </div>
          ...
          <div class="row">
              ...
              <label for="peso" class="col-sm-2 col-form-label">Muslo:</label>
                <div class="col-md-3">
                  <div class="input-group">
                        <span class="input-group-addon"><?php echo $datos_evaluacion->muslo_paciente." "?>Cms.</span>
                    </div>
                </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group row">
              <label for="talla" class="col-sm-2 col-form-label">Pantorrilla:</label>
                <div class="col-md-3">
                  <div class="input-group">
                        <span class="input-group-addon"><?php echo $datos_evaluacion->pantorrilla2_paciente." "?>Cms.</span>
                  </div>
                </div>
            </div>
          </div>
          ...
          <div class="row">
              ...
              <label for="peso" class="col-sm-3 col-form-label"><strong>Σ 4 pliegues:</strong></label>
                <div class="col-md-3">
                  <div class="input-group">
                        <span class="input-group-addon"><?php echo $datos_evaluacion->cuatro_pliegues_paciente." "?>Cms.</span>
                    </div>
                </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group row">
              <label for="talla" class="col-sm-3 col-form-label"><strong>grasa Durnin:</strong></label>
                <div class="col-md-3">
                  <div class="input-group">
                        <span class="input-group-addon"><?php echo $datos_evaluacion->grasa_durnin_paciente." "?>%</span>
                  </div>
                </div>
            </div>
          </div>
          ...
          <div class="row">
              ...
              <label for="peso" class="col-sm-3 col-form-label"><strong>Masa Adiposa:</strong></label>
                <div class="col-md-3">
                  <div class="input-group">
                        <span class="input-group-addon"><?php echo $datos_evaluacion->masa_adiposa_paciente." "?>kgs.</span>
                    </div>
                </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group row">
              <label for="talla" class="col-sm-3 col-form-label"><strong>Masa libre grasa:</strong></label>
                <div class="col-md-3">
                  <div class="input-group">
                        <span class="input-group-addon"><?php echo $datos_evaluacion->masa_sin_grasa_paciente." "?>Kgs.</span>
                  </div>
                </div>
            </div>
          </div>
          ...
          <div class="row">
              ...
              <label for="peso" class="col-sm-3 col-form-label"><strong>Masa Muscular:</strong></label>
                <div class="col-md-3">
                  <div class="input-group">
                        <span class="input-group-addon"><?php echo $datos_evaluacion->masa_muscular_paciente." "?>Cms.</span>
                    </div>
                </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group row">
              <label for="talla" class="col-sm-3 col-form-label"><strong>Σ 6 pliegues:</strong></label>
                <div class="col-md-3">
                  <div class="input-group">
                        <span class="input-group-addon"><?php echo $datos_evaluacion->seis_pliegues_paciente." "?>Cms.</span>
                  </div>
                </div>
            </div>
          </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <h3>Estado nutricional: <?php echo $datos_evaluacion->estado;?></h3>
          </div>
        </div>
      </div>
    </div>
