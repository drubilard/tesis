    ...
    <div id="header" class="header navbar-default">
			<nav aria-label="breadcrumb">
  				<ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page">Evaluaciones</li>
  				</ol>
			</nav>  			
	...
	<div id="page-container" class="fade">
		...
		<div class="login login-v2 " data-pageload-addclass="animated fadeIn ">
			...
			<div class="login-header row animated bounceInLeft">
				<div class="brand ">
					<img src="<?php echo base_url();?>assets/img/logo/logo.png" style="height: 70px;"> <b>NUTRICIÓN</b> Evaluaciones
				</div>
			...
			<!-- begin login-content -->
					...
					<div class="login-buttons row animated bounceIn">
						<a href="<?php echo base_url();?>evaluacion/planilla_evaluacion/<?php echo $rut_paciente?>" class="btn btn-success btn-block btn-lg">Nueva Evaluación</a>
						<a href="<?php echo base_url();?>evaluacion/listado_evaluaciones/<?php echo $rut_paciente?>" class="btn btn-warning btn-block btn-lg">Consultar evaluaciones</a>
					</div>
