        ...
        <div id="desayuno" class="collapse" aria-labelledby="headingOne1" data-parent="#accordion">
          <div class="card-body">
            ...
            <?php foreach($preparaciones as $preparacion){?>
                <?php if ($preparacion->tipo=='desayuno'){?><input type="checkbox" <?php foreach($minuta_preparaciones as $value){if($preparacion->idpreparacion==$value->preparacion_idpreparacion){?>checked <?php }}  ?>  name="preparaciones_minuta_des[]" value="<?php echo $preparacion->idpreparacion;?>"> <span class="color-preparacion"> <?php echo $preparacion->nombre;?></span>
                <hr><?php }?>
            <?php } ?>
          </div>
        </div>
      ...
      <div class="card">
        ...
        <div id="colacion_1" class="collapse" aria-labelledby="headingOne1" data-parent="#accordion">
          <div class="card-body">
            <!-- ingresar-->
            <?php foreach($preparaciones as $preparacion){?>
                <?php if ($preparacion->tipo=='colacion_1'){?><input type="checkbox" <?php foreach($minuta_preparaciones as $value){if($preparacion->idpreparacion==$value->preparacion_idpreparacion){?>checked <?php }}  ?>  name="preparaciones_minuta_col[]" value="<?php echo $preparacion->idpreparacion;?>"> <span class="color-preparacion"> <?php echo $preparacion->nombre;?></span>
                <hr><?php }?>
            <?php } ?>
          </div>
        </div>
      ...
      <div class="card">
        ...
        <div id="entrada" class="collapse" aria-labelledby="headingOne1" data-parent="#accordion">
          <div class="card-body">
            <!-- ingresar-->
            <?php foreach($preparaciones as $preparacion){?>
                <?php if ($preparacion->tipo=='entrada'){?><input type="checkbox"  <?php foreach($minuta_preparaciones as $value){if($preparacion->idpreparacion==$value->preparacion_idpreparacion){?>checked <?php }}  ?> name="preparaciones_minuta_ent[]" value="<?php echo $preparacion->idpreparacion;?>"> <span class="color-preparacion"> <?php echo $preparacion->nombre;?></span>
                <hr><?php }?>
            <?php } ?>
          </div>
        </div>
      ...
      <div class="card">
        ...
        <div id="almuerzo" class="collapse" aria-labelledby="headingOne1" data-parent="#accordion">
          <div class="card-body">
            <!-- ingresar-->
            <?php foreach($preparaciones as $preparacion){?>
                <?php if ($preparacion->tipo=='almuerzo'){?><input type="checkbox" <?php foreach($minuta_preparaciones as $value){if($preparacion->idpreparacion==$value->preparacion_idpreparacion){?>checked <?php }}  ?>  name="preparaciones_minuta_alm[]" value="<?php echo $preparacion->idpreparacion;?>"> <span class="color-preparacion">  <?php echo $preparacion->nombre;?></span>
                <hr><?php }?>
            <?php } ?>
          </div>
        </div>
      ...
      <div class="card">
        ...
        <div id="colacion_2" class="collapse" aria-labelledby="headingOne1" data-parent="#accordion">
          <div class="card-body">
            <!-- ingresar-->
            <?php foreach($preparaciones as $preparacion){?>
                <?php if ($preparacion->tipo=='colacion_2'){?><input type="checkbox" <?php foreach($minuta_preparaciones as $value){if($preparacion->idpreparacion==$value->preparacion_idpreparacion){?>checked <?php }}  ?>  name="preparaciones_minuta_col_2[]" value="<?php echo $preparacion->idpreparacion;?>"> <span class="color-preparacion"> <?php echo $preparacion->nombre;?></span>
                <hr><?php }?>
            <?php } ?>
          </div>
        </div>
      ...
      <div class="card">
        ...
        <div id="once" class="collapse" aria-labelledby="headingOne1" data-parent="#accordion">
          <div class="card-body">
            <!-- ingresar-->
            <?php foreach($preparaciones as $preparacion){?>
                <?php if ($preparacion->tipo=='once'){?><input type="checkbox" <?php foreach($minuta_preparaciones as $value){if($preparacion->idpreparacion==$value->preparacion_idpreparacion){?>checked <?php }}  ?>  name="preparaciones_minuta_on[]" value="<?php echo $preparacion->idpreparacion;?>"> <span class="color-preparacion"> <?php echo $preparacion->nombre;?></span>
                <hr><?php }?>
            <?php } ?>
          </div>
        </div>
      ...
      <div class="card">
        ...
        <div id="cena" class="collapse" aria-labelledby="headingOne1" data-parent="#accordion">
          <div class="card-body">
            <!-- ingresar-->
            <?php foreach($preparaciones as $preparacion){?>
                <?php if ($preparacion->tipo=='cena'){?><input type="checkbox" <?php foreach($minuta_preparaciones as $value){if($preparacion->idpreparacion==$value->preparacion_idpreparacion){?>checked <?php }}  ?>  name="preparaciones_minuta_cen[]" value="<?php echo $preparacion->idpreparacion;?>"> <span class="color-preparacion"> <?php echo $preparacion->nombre;?></span>
                <hr><?php }?>
            <?php } ?>
          </div>
        </div>
