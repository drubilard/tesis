...
<body class="pace-top">
    ...
    <div id="header" class="header navbar-default row justify-content-center justify-content-md-start">
			<!-- begin navbar-header -->
				<div class="navbar-header col-xs-8 col-md-8 col-lg-10">
					<a href="<?php echo base_url();?>administrador/crear_usuario" class="navbar-brand"><img src="<?php echo base_url();?>assets/img/logo/logo.png"  > <b>NUTRICIÓN</b> </a>
				</div>
		...
		<div id="header" class="header navbar-default">
			<nav aria-label="breadcrumb">
  				<ol class="breadcrumb">
    				<li class="breadcrumb-item"><a href="<?php echo base_url();?>Administrador/crear_usuario"><strong>Administrador</strong></a></li>
    				<li class="breadcrumb-item" aria-current="page">activar usuario</li>
  				</ol>
			</nav>  			
    ...
    <div class="panel panel-success">
        ...
        <div class="panel-heading">Listado de usuarios desactivados</div>
	...
	<script src="<?php echo base_url();?>assets/js/demo/busqueda_usuarios_des.js"></script>
	<!-- ================== END BASE JS ================== -->
