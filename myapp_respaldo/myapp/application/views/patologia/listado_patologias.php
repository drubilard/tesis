...
<body class="pace-top">
		...
		<div id="header" class="header navbar-default">
			<nav aria-label="breadcrumb">
  				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item" aria-current="page">Gestión de patologías</li>
  				</ol>
			</nav>  			
					...
					<div class="col-md-3 col-xs-5">
    						<div class="input-group">
								<span class="input-group-addon "><span class=" glyphicon glyphicon-search" aria-hidden="true"></span></span>
      							<input type="text" autofocus="true" name="busqueda" class="form-control form-control-lg" id="b_contraido_id" placeholder="buscar patología..">
							</div>
					</div>
				</div>
			</div>
	...
	<script src="<?php echo base_url();?>assets/js/demo/busqueda_patologia.js"></script>
	<!-- ================== END BASE JS ================== -->
